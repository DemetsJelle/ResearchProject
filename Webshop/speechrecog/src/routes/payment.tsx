                ...
                <div className="form_textC">
                    ...
                    <div className="form_divs">
                        <div className='input_container u-1-of-2'>
                            ...
                            <input type="text" className="input_from" placeholder="Jon" value={voornaam}/>
                        </div>
                        <div className='input_container u-1-of-2'>
                            <label>Achternaam</label>
                            <input type="text" className="input_from" placeholder="Doe" value={achternaam}/>
                        </div>
                    </div>
                    <div style={{display:'flex'}}>
                        <div className="input_container u-2-of-3">
                            <label>Email</label>
                            <input type="email" className="input_from" placeholder="voornaam.achernaam@email.com" value={email}/>
                        </div>
                    </div>
                    <div className="form_divs">
                        <div className='input_container u-3-of-4'>
                            <label>Straat</label>
                            <input type="text" className="input_from" placeholder="Duifhuisstraat" value={straat}/>
                        </div>
                        <div className="input_container u-1-of-4">
                            <label>Nr</label>
                            <input type="text" className="input_from" placeholder="42" value={nummer}/>
                        </div>
                    </div>
                    ...
                    <div style={{display:'flex'}}>
                        <div className='input_container u-1-of-2'>
                            <label>Stad</label>
                            <input type="text" className="input_from" placeholder="Kruissem" value={stad}/>
                        </div>
                    </div>
