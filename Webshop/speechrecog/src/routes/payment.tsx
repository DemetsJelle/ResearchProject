...
export default function PaymentPage(){
    ...
    const commands = [
        {
            command:['voornaam :x'],
            callback:(spokenText:any) => setVoornaam(spokenText),
        },
        {
            command:['achternaam :x'],
            callback:(spokenText:any) => setAchternaam(spokenText),
        },
        {
            command:['email :x'],
            callback:(spokenText:any) => setEmail(spokenText),
        },
        {
            command:['straat :x'],
            callback:(spokenText:any) => setStraat(spokenText),
        },
        {
            command:['nummer :x'],
            callback:(spokenText:any) => setNummer(spokenText),
        },
        {
            command:['stad :x'],
            callback:(spokenText:any) => setStad(spokenText),
        },
        {
            command: ['terug'],
            callback:() => goBack()
        ...
        <main className="app">
            ...
            <div className="form_container">
                <div className="form_textC">
                    ...
                    <div className="form_divs">
                        <div className='input_container u-3-of-4'>
                            <label>Straat</label>
                            <input type="text" 
                                className="input_from" 
                        ...
                        <div className="input_container u-1-of-4">
                            <label>Nr</label>
                            <input type="text" 
                                className="input_from" 
                                placeholder="42" 
